...
#ifndef CASL_HAMILTONIAN_ADVECTION_2D_H
#define CASL_HAMILTONIAN_ADVECTION_2D_H

#include "../../../CASLCommonLibrary/CaslHamiltonian2D.h"
#include "../../../CASLCommonLibrary/CaslArray2D.h"

class CaslHamiltonianAdvection2D : public CaslHamiltonian2D {
public:
    CaslArray2D<double> _c1;
    CaslArray2D<double> _c2;
    const double _constant = 0.0; // Modify if needed

    explicit CaslHamiltonianAdvection2D(CaslGrid2D& grid, CaslArray2D<double> & c1, CaslArray2D<double> & c2);
...
#endif //CASL_HAMILTONIAN_ADVECTION_2D_H
