...
#ifndef CASL_HAMILTONIAN_REINITIALIZATION_2D_H
#define CASL_HAMILTONIAN_REINITIALIZATION_2D_H

#include "../../../CASLCommonLibrary/CaslHamiltonian2D.h"
#include "../../../CASLCommonLibrary/CaslArray2D.h"

class CaslHamiltonianReinitialization2D : public CaslHamiltonian2D {
public:
    CaslArray2D<double> & _signPhi0;

    explicit CaslHamiltonianReinitialization2D(CaslGrid2D& grid, CaslArray2D<double> & signPhi0);
...
#endif //CASL_HAMILTONIAN_REINITIALIZATION_2D_H
